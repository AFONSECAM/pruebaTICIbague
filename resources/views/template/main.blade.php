...
<head>
    ...
    <title>@yield('title') - Andres Fonseca</title>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block {{ (Request::routeIs('employee.*')) ? 'active' : '' }}">
                    <a href="{{ route('employee.index') }}" class="nav-link">Empleados</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block {{ (Request::routeIs('department.*')) ? 'active' : '' }}">
                    <a href="{{ route('department.index') }}" class="nav-link">Departamentos</a>
                </li>
                {{--  <li class="nav-item d-none d-sm-inline-block {{ (Request::routeIs('users.*')) ? 'active' : '' }}">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/dashboard" class="brand-link">
                ...
                <span class="brand-text font-weight-light">PruebaTIC</span>
            </a>
